...
class WorkspaceDashboard extends Component {
    ...
    handleCreateNewProject = () => {
        ...
        this.props.history.push(`${this.props.match.url}/create-new-project`);
    };
    ...
    render() {
        ...
        return (
            <div className="load-project">
                <Button size="large" onClick={this.handleLoadExistProject}>打开老项目</Button>
                <Button size="large" onClick={this.handleCreateNewProject}>创建新项目</Button>
...
export default connect(mapStateToProps, mapDispatchToProps)(WorkspaceDashboard);
